frappe.ui.form.on("Sales Invoice", {
    ...
    if(frm.doc.po_no )
    {
    var j = "Dear Valued Customer, We have shipped your material by road via Vehicle No. "+frm.doc.vehicle_no+" (Driver's Name and Contact No. -"+frm.doc.driver_name+") for your PO "+frm.doc.po_no +".List of materials is as follows: " ;
    }
    else{

        var j = "Dear Valued Customer, We have shipped your material by road via Vehicle No. "+frm.doc.vehicle_no+" (Driver's Name and Contact No. -"+frm.doc.driver_name+") for your PO.List of materials is as follows: ";
    ...
    $.each(frm.doc.items, function(index,row)
    {
        if(frm.doc.items.length != index+1 )
        {
            ...
            j = j + row.item_name +"  "+row.uom+"  "+row.qty +","

        }else 
           {

            j = j + row.item_name +"  "+row.uom+"  "+row.qty +".Thank you for your order."
